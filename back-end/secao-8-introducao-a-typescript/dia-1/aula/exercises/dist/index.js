...
console.log("\nÁREA DE UM:");
console.log(`- Círculo de raio 25cm: ${Ex.getCircleArea(25)}`);
console.log(`- Círculo de raio 100cm: ${Ex.getCircleArea(100)}`);
console.log(`- Círculo de raio 12,5cm: ${Ex.getCircleArea(12.5)}`);
