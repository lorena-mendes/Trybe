...
export function getDiamondArea(diagonaLarger: number, diagonalSmaller: number): number {
  return (diagonaLarger * diagonalSmaller) / 2;
}

export function getTrapezeArea(biggerBase: number, minorBase: number, height: number): number {
